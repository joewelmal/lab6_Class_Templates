 ...
 *
 * Data:
 * A collection of metric values with a fixed capacity.
 *
 * Operations:
 * add(value): Adds a value if space is available.
 ...
 * isEmpty(): Returns true if no values are stored.
 */
...
int main()
{
    ...
    // TODO (Part E): Print descriptive English labels for 
